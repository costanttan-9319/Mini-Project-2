...
function Home() {
  ...
  useEffect(() => {
    ...
    // --- LOGIC: CHECK LOGIN STATUS ON LOAD ---
    ...
    <Box sx={{ p: 4 }}>
      ...
      >
        ...
        <Autocomplete
          ...
          onChange={(e, v) => setSelectedCuisine(v)}
        />
        <Button
          variant="contained"
      ...
      >
        {results?.map((store) => {
          ...
          const isAlways24h =
            store.openingHours &&
            Object.values(store.openingHours).every((h) =>
              h.toLowerCase().includes("24 hours"),
            );
          ...
          return (
            ...
            >
        {/* 1. THE DISPLAY CASE (This Box keeps the shield sized correctly to the image) */}
              <Box sx={{ position: 'relative', width: '100%', height: 180, overflow: 'hidden' }}>
                
                {/* 2. THE PHOTO (This is your original image logic) */}
                ...
                {/* 3. THE GHOST SHIELD (The invisible layer that sits ON TOP of the image) */}
                <Box 
              ...
              <CardContent>
                ...
                <Typography
                  variant="body1"
                  sx={{ fontWeight: "bold", color: "#ffa000", mt: 1 }}
                >
                  ⭐ {store.rating}
                </Typography>
                ...
                {store.openingHours &&
                typeof store.openingHours === "object" ? (
                  <Box
                    ...
                    {Object.entries(store.openingHours).map(([day, hours]) => (
                      ...
                      >
                        ...
                        <Typography
                          ...
                          sx={{
                            fontWeight: day === currentDay ? "bold" : "normal",
                            color: hours.toLowerCase().includes("24 hours")
                              ? "success.main"
                              : "inherit",
                          }}
                        >
